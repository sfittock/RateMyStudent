def ask_questions():
    ...
    responses = [
        ...
        [
            "The student usually has bad behaviour in the classroom and the playground.",
            "The student sometimes shows poor behaviour in the classroom and playground.",
            "The student mostly has good behaviour in the classroom and playground.",
        ...
        [
            "The student finds it difficult to effectively cooperate with others.",
            ...
            "The student enjoys working with others and is usually able to work effectively in a group.",
        ...
        [
            ...
            "The student often uses good listening skills to understand and carry out instructions provided by the teacher.",
            "The student has consistently demonstrated excellent listening and instruction following skills.",
        ],
        [
            "The student is unorganised, which impacts their learning.",
